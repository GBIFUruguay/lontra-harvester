...
public class DefaultMessage implements ProcessingMessageIF {
	...
	public String toString() {
		return new ToStringBuilder(this).append("timestamp", timestamp).append("msgHandlerClass", msgHandlerClass)
				.append("contentClass", contentClass).append("content", content).toString();
	}
}
