...
public class JobUId {
	...
	public int hashCode() {
		...
		return new HashCodeBuilder(13, 411).append(uid).append(sourceFileId).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(uid, eObj.uid).append(sourceFileId, eObj.sourceFileId).isEquals();
	}
