...
public class ResourceStatusCheckerTest {
	...
	public void testGetHarvestRequiredList() {
		...
		jdbcTemplate.update("INSERT INTO import_log (sourcefileid,gbif_package_id,updated_by,event_end_date_time) VALUES " +
				"('qmor-specimens','ada5d0b1-07de-4dc0-83d4-e312f0fb81cb','Jim','2015-06-26')");
